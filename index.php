  ...
  <main>
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Fapurison Collection.<br>
				muranga town
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0705130857">0705130857</a>
				</div>
				<div class="phone">
					Whatsapp:
					<a class="whatsapp" href="https://wa.me/">0705130857</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:martinmuchui34@gmail.com" class="email__addr">martinmuchui34@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2023 Fapurison collection&trade;
			</div>

			<div class="developer">
				Dev by Martin Maingi
			</div>

			<div class="designby">
				Design by Martin Maingi
			</div>
		</div>
	</div>
</footer>
